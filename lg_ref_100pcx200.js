...
p.nominalBounds = new cjs.Rectangle(0,0,249,193);


(lib.hol2 = function() {
	this.initialize(img.hol2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,199,195);
...
p.nominalBounds = new cjs.Rectangle(-99,-97,199,195);
...
(lib.Symbol16 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.rf(["#FFFFFF","#D4D2D2"],[0,1],-232.6,-29.3,0,-232.6,-29.3,763.6).s().p("EicOAPnIAA/NME4dAAAIAAfNg");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1000,-100,2000,200);
...
p.nominalBounds = new cjs.Rectangle(-124,-96,249,193);
...
(lib.Symbol2 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#333333").s().p("AA4BBIAAhvIgBAAIgsBvIgVAAIgrhvIgCAAIAABvIgWAAIAAiBIAjAAIAqBvIABAAIAshvIAhAAIAACBg");
	this.shape.setTransform(228.1,3.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#333333").s().p("AgeA/QgLgEgGgJQgHgJgDgNQgDgNAAgPQAAgiAQgQQAPgRAfAAQARAAALAFQAMAFAGAIQAHAJADANQADANAAAOQAAAjgQARQgQAQgfAAQgQAAgMgFgAgdglQgJAOAAAYQAAALACAJQABAJAFAHQAEAHAHAEQAHADAKAAQAWAAAKgNQAJgNAAgZQAAgKgCgKQgCgJgEgHQgEgGgHgEQgHgFgLAAQgWAAgJAOg");
	this.shape_1.setTransform(212,3.1);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#333333").s().p("Ag2g+IgCggIASAAIADAJQAIgFAJgDQAKgFALAAQAcAAANARQANASAAAgQAAAPgDAOQgEALgHAIQgIAKgMAFQgMAGgOAAQgLAAgIgDIgLgEIAABBIgVADgAgWhLIgLAHIAABRQANAHAOABQATAAALgNQALgLAAgcQAAgKgCgJQgCgJgEgHQgFgGgHgEQgHgFgJAAQgMAAgJAGg");
	this.shape_2.setTransform(198.7,6.2);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#333333").s().p("AgeA/QgLgEgGgJQgHgJgDgNQgDgNAAgPQAAgiAQgQQAPgRAfAAQARAAALAFQAMAFAGAIQAHAJADANQADANAAAOQAAAjgQARQgQAQgfAAQgQAAgMgFgAgdglQgJAOAAAYQAAALACAJQABAJAFAHQAEAHAHAEQAHADAKAAQAWAAAKgNQAJgNAAgZQAAgKgCgKQgCgJgEgHQgEgGgHgEQgHgFgLAAQgWAAgJAOg");
	this.shape_3.setTransform(184.8,3.1);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#333333").s().p("AglAzQgPgRAAggQAAghARgSQARgSAeAAQANAAALAEQALAEAGAIIgNAMQgFgFgHgDQgHgDgJAAQgTAAgLANQgMANAAAbQAAAKADAJQACAJAFAHQAFAGAHAEQAIADAKAAQALAAAJgCIAQgGIAFAPQgGADgMAEQgMADgNAAQgfAAgOgRg");
	this.shape_4.setTransform(172.5,3.1);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#333333").s().p("AglAzQgPgRAAggQAAghARgSQARgSAeAAQANAAALAEQALAEAGAIIgNAMQgFgFgHgDQgHgDgJAAQgTAAgLANQgMANAAAbQAAAKADAJQACAJAFAHQAFAGAHAEQAIADAKAAQALAAAJgCIAQgGIAFAPQgGADgMAEQgMADgNAAQgfAAgOgRg");
	this.shape_5.setTransform(161,3.1);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#333333").s().p("AgXBAQgLgEgIgJQgHgIgDgNQgDgNAAgRQAAgiAPgQQAPgRAcAAQAQAAALAFQAKAFAGAIQAGAJACALQACAMAAAOIAAAIIhZAAQAAALACAIQADAKAFAGQAFAGAIADQAIACAJAAQAOAAAKgDQALgEAGgDIAGAPIgJAEIgMAEIgOADIgPABQgPAAgMgEgAgNgvQgHADgFAGQgEAHgCAKIgCAMIBCAAQAAgXgIgJQgIgKgOAAQgJAAgHAEg");
	this.shape_6.setTransform(148.7,3.1);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#333333").s().p("Ag2g+IgCggIASAAIADAJQAIgFAJgDQAKgFALAAQAcAAANARQANASAAAgQAAAPgDAOQgEALgHAIQgIAKgMAFQgMAGgOAAQgLAAgIgDIgLgEIAABBIgVADgAgWhLIgLAHIAABRQANAHAOABQATAAALgNQALgLAAgcQAAgKgCgJQgCgJgEgHQgFgGgHgEQgHgFgJAAQgMAAgJAGg");
	this.shape_7.setTransform(135.8,6.2);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#333333").s().p("AAfBBIAAhwIg9AAIAABwIgVAAIAAiBIBnAAIAACBg");
	this.shape_8.setTransform(122.2,3.1);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#333333").s().p("AA4BBIAAhvIgCAAIgrBvIgVAAIgrhvIgCAAIAABvIgWAAIAAiBIAjAAIAqBvIABAAIArhvIAiAAIAACBg");
	this.shape_9.setTransform(106.3,3.1);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#333333").s().p("AgeA/QgLgEgGgJQgHgJgDgNQgDgNAAgPQAAgiAQgQQAPgRAfAAQARAAALAFQAMAFAGAIQAHAJADANQADANAAAOQAAAjgQARQgQAQgfAAQgQAAgMgFgAgdglQgJAOAAAYQAAALACAJQABAJAFAHQAEAHAHAEQAHADAKAAQAWAAAKgNQAJgNAAgZQAAgKgCgKQgCgJgEgHQgEgGgHgEQgHgFgLAAQgWAAgJAOg");
	this.shape_10.setTransform(90.2,3.1);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#333333").s().p("AAeBBIgyg6IgNAAIAAA6IgWAAIAAiBIAWAAIAAA4IANAAIAxg4IAYAAIg4BAIA7BBg");
	this.shape_11.setTransform(78.1,3.1);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#333333").s().p("AA5BBIAAhvIgCAAIgrBvIgXAAIgqhvIgDAAIAABvIgUAAIAAiBIAjAAIApBvIACAAIArhvIAgAAIAACBg");
	this.shape_12.setTransform(56.3,3.1);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#333333").s().p("AA0BBIAAiBIAVAAIAACBgAhIBBIAAiBIAVAAIAAAwIAnAAQAJAAAHADQAIACAFAFQAGAFAEAGQAEAHAAALQAAAVgNALQgNAKgTAAgAgzAwIAjAAQAMAAAFgGQAHgGAAgNQAAgMgHgGQgFgFgMAAIgjAAg");
	this.shape_13.setTransform(38.4,3.1);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#333333").s().p("AAfBBIAAg6Ig9AAIAAA6IgWAAIAAiBIAWAAIAAA3IA9AAIAAg3IAWAAIAACBg");
	this.shape_14.setTransform(22.8,3.1);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#333333").s().p("AAkBhIAAhvIgCAAIg5BvIghAAIAAiBIAVAAIAABvIACAAIA6hvIAgAAIAACBgAgdg+QgKgMAAgWIASAAQAAAOAGAIQAFAIAMAAQANAAAFgIQAGgIAAgOIASAAQAAAWgKAMQgKAMgWAAQgVAAgKgMg");
	this.shape_15.setTransform(8.9,-0.1);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#333333").s().p("AgXBAQgLgEgIgJQgHgIgDgNQgDgNAAgRQAAgiAPgQQAPgRAcAAQAQAAALAFQAKAFAGAIQAGAJACALQACAMAAAOIAAAIIhZAAQAAALACAIQADAKAFAGQAFAGAIADQAIACAJAAQAOAAAKgDQALgEAGgDIAGAPIgJAEIgMAEIgOADIgPABQgPAAgMgEgAgNgvQgHADgFAGQgEAHgCAKIgCAMIBCAAQAAgXgIgJQgIgKgOAAQgJAAgHAEg");
	this.shape_16.setTransform(-4.6,3.1);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#333333").s().p("AAfBBIAAg6Ig9AAIAAA6IgWAAIAAiBIAWAAIAAA3IA9AAIAAg3IAWAAIAACBg");
	this.shape_17.setTransform(-17.7,3.1);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#333333").s().p("AAkBBIAAhvIgCAAIg5BvIghAAIAAiBIAVAAIAABvIACAAIA6hvIAgAAIAACBg");
	this.shape_18.setTransform(-31.6,3.1);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#333333").s().p("AhHBeIgIgCIACgUIAFACIAGAAQAKAAAFgMQAGgKAFgWQADgWABgdIADhIIBwAAIAAC6IgWAAIAAioIhFAAIgBAVIgBAaIgCAcIgDAbIgGAdQgDANgFAIQgFAJgIAEQgHAEgLABIgHgBg");
	this.shape_19.setTransform(-48.4,0.3);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#333333").s().p("AA4BBIAAhvIgCAAIgrBvIgVAAIgrhvIgCAAIAABvIgWAAIAAiBIAjAAIAqBvIABAAIArhvIAiAAIAACBg");
	this.shape_20.setTransform(-70.6,3.1);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#333333").s().p("AA0BBIAAiBIAWAAIAACBgAhJBBIAAiBIAWAAIAAAwIAmAAQAKAAAGADQAJACAGAFQAGAFADAGQADAHAAALQAAAVgMALQgMAKgUAAgAgzAwIAkAAQALAAAFgGQAHgGAAgNQAAgMgHgGQgFgFgLAAIgkAAg");
	this.shape_21.setTransform(-88.6,3.1);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#333333").s().p("AAfBBIAAg6Ig9AAIAAA6IgWAAIAAiBIAWAAIAAA3IA9AAIAAg3IAWAAIAACBg");
	this.shape_22.setTransform(-104.1,3.1);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#333333").s().p("Ag2g+IgCggIASAAIADAJQAIgFAJgDQAKgFALAAQAcAAANARQANASAAAgQAAAPgDAOQgEALgHAIQgIAKgMAFQgMAGgOAAQgLAAgIgDIgLgEIAABBIgVADgAgWhLIgLAHIAABRQANAHAOABQATAAALgNQALgLAAgcQAAgKgCgJQgCgJgEgHQgFgGgHgEQgHgFgJAAQgMAAgJAGg");
	this.shape_23.setTransform(-117.3,6.2);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#333333").s().p("AgeA/QgLgEgGgJQgHgJgDgNQgDgNAAgPQAAgiAQgQQAPgRAfAAQARAAALAFQAMAFAGAIQAHAJADANQADANAAAOQAAAjgQARQgQAQgfAAQgQAAgMgFgAgdglQgJAOAAAYQAAALACAJQABAJAFAHQAEAHAHAEQAHADAKAAQAWAAAKgNQAJgNAAgZQAAgKgCgKQgCgJgEgHQgEgGgHgEQgHgFgLAAQgWAAgJAOg");
	this.shape_24.setTransform(-131.2,3.1);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#333333").s().p("AgJBBIAAhwIgrAAIAAgRIBpAAIAAARIgrAAIAABwg");
	this.shape_25.setTransform(-143.4,3.1);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#333333").s().p("Ag2g+IgCggIASAAIADAJQAIgFAJgDQAKgFALAAQAcAAANARQANASAAAgQAAAPgDAOQgEALgHAIQgIAKgMAFQgMAGgOAAQgLAAgIgDIgLgEIAABBIgVADgAgWhLIgLAHIAABRQANAHAOABQATAAALgNQALgLAAgcQAAgKgCgJQgCgJgEgHQgFgGgHgEQgHgFgJAAQgMAAgJAGg");
	this.shape_26.setTransform(-155.3,6.2);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#333333").s().p("AgXBAQgLgEgIgJQgHgIgDgNQgDgNAAgRQAAgiAPgQQAPgRAcAAQAQAAALAFQAKAFAGAIQAGAJACALQACAMAAAOIAAAIIhZAAQAAALACAIQADAKAFAGQAFAGAIADQAIACAJAAQAOAAAKgDQALgEAGgDIAGAPIgJAEIgMAEIgOADIgPABQgPAAgMgEgAgNgvQgHADgFAGQgEAHgCAKIgCAMIBCAAQAAgXgIgJQgIgKgOAAQgJAAgHAEg");
	this.shape_27.setTransform(-168.6,3.1);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#333333").s().p("Ag1BBIAAiBIA8AAQATAAALAHQAMAJAAAQQAAAMgHAHQgFAHgKAEIAKACQAFACADADQAEAEACAGQACAGAAAIQABAJgEAHQgEAHgGAFQgGAEgIACQgHACgIAAgAgfAwIAjAAQALAAAIgFQAJgDAAgNQgBgNgHgEQgIgGgNAAIgiAAgAgfgJIAjAAQANAAAFgFQAFgHAAgIQAAgKgHgFQgHgEgMAAIggAAg");
	this.shape_28.setTransform(-181,3.1);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#333333").s().p("AAfBBIAAg6Ig9AAIAAA6IgWAAIAAiBIAWAAIAAA3IA9AAIAAg3IAWAAIAACBg");
	this.shape_29.setTransform(-194.6,3.1);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f("#333333").s().p("AA0BeIAAipIgDAAIhVCpIglAAIAAi7IAWAAIAACpIADAAIBVipIAlAAIAAC7g");
	this.shape_30.setTransform(-210.4,0.2);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f("#333333").s().p("AglAzQgPgRAAggQAAghARgSQARgSAeAAQANAAALAEQALAEAGAIIgNAMQgFgFgHgDQgHgDgJAAQgTAAgLANQgMANAAAbQAAAKADAJQACAJAFAHQAFAGAHAEQAIADAKAAQALAAAJgCIAQgGIAFAPQgGADgMAEQgMADgNAAQgfAAgOgRg");
	this.shape_31.setTransform(-230.6,3.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_31},{t:this.shape_30},{t:this.shape_29},{t:this.shape_28},{t:this.shape_27},{t:this.shape_26},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-239,-18.1,478.1,36.2);
...
(lib.Symbol1 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#333333").s().p("AhfB0QgkgpAAhLQAAhNApgnQAognBFAAQAigBAeALQAdALAUAYIglAgQgNgOgSgIQgTgJgZAAQgqAAgXAdQgXAeAAA2QAAA0AXAaQAYAbApgBIAcgBIATgEIAAhHIg/AAIAAgtIB7AAIAACVQgWAKgcAGQgcAEggAAQhMAAgkgog");
	this.shape.setTransform(222.1,0.9);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#333333").s().p("AhbCYIAAkvIA9AAIAAD/IB6AAIAAAwg");
	this.shape_1.setTransform(198.3,0.9);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#333333").s().p("AArBpIAAiiIgDAAIg4CiIhUAAIAAjRIA5AAIAACiIAEAAIA3iiIBUAAIAADRg");
	this.shape_2.setTransform(164.5,5.5);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#333333").s().p("AAkBpIhAhUIgOAAIAABUIg8AAIAAjRIA8AAIAABTIAOAAIA/hTIBAAAIhSBmIBWBrg");
	this.shape_3.setTransform(143.5,5.5);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#333333").s().p("AArBpIAAiiIgDAAIg3CiIhVAAIAAjRIA6AAIAACiIADAAIA3iiIBVAAIAADRg");
	this.shape_4.setTransform(119.2,5.5);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#333333").s().p("AAhBpIAAhUIhBAAIAABUIg8AAIAAjRIA8AAIAABTIBBAAIAAhTIA8AAIAADRg");
	this.shape_5.setTransform(96,5.5);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#333333").s().p("AhdBpIAAjRIA7AAIAABHIA1AAQAPAAAOAFQAOAEAKAIQAKAJAGALQAGANAAARQAAATgGANQgGAOgLAIQgLAJgPAEQgPAEgSAAgAgiBAIAlAAQAeAAAAgeQAAgMgHgHQgIgIgPAAIglAAg");
	this.shape_6.setTransform(74.8,5.5);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#333333").s().p("AheBqIgMgDIADguIAGAAIAGABQAGAAAFgCQAEgCADgGQAEgFACgLIAEgZIACgZIACggIABgfIAAgYIClAAIAADRIg8AAIAAilIgzAAIgCAgIgEArQgGAxgQAWQgPAVgfABIgQgBg");
	this.shape_7.setTransform(50.8,5.7);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#333333").s().p("AAsBpIAAiiIgEAAIg3CiIhVAAIAAjRIA6AAIAACiIADAAIA4iiIBUAAIAADRg");
	this.shape_8.setTransform(28.5,5.5);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#333333").s().p("ABHCGIAAg5IiNAAIAAA5IgzAAIAAhmIAWAAQAIgPAEgRQAFgRADgVQADgUABgYIADgzICkAAIAAClIAeAAIAABmgAgbgVQgFAfgKAWIBLAAIAAh5Ig1AAQgCAigFAig");
	this.shape_9.setTransform(4,8.4);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#333333").s().p("Ag0BmQgUgHgMgPQgMgOgEgVQgFgUAAgZQAAg2AbgcQAagbA4AAQAeAAATAIQAUAHALAPQAMAOAFAVQAFAVAAAYQAAA3gbAbQgbAbg4AAQgdAAgTgIgAghgyQgLASAAAiQAAAOACANQACAMAEAJQAEAKAIAFQAIAFAMAAQAcAAALgSQAKgTAAgiQAAgOgBgNQgDgMgEgJQgEgJgJgGQgHgFgNAAQgbAAgKATg");
	this.shape_10.setTransform(-19.6,5.5);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#333333").s().p("AheBqIgMgDIADguIAGAAIAGABQAGAAAFgCQAEgCADgGQAEgFACgLIAEgZIACgZIACggIABgfIAAgYIClAAIAADRIg8AAIAAilIgzAAIgCAgIgEArQgGAxgQAWQgPAVgfABIgQgBg");
	this.shape_11.setTransform(-44,5.7);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#333333").s().p("Ag0BmQgUgHgMgPQgMgOgEgVQgFgUAAgZQAAg2AbgcQAagbA4AAQAeAAATAIQAUAHALAPQAMAOAFAVQAFAVAAAYQAAA3gbAbQgbAbg4AAQgdAAgTgIgAghgyQgLASAAAiQAAAOACANQACAMAEAJQAEAKAIAFQAIAFAMAAQAcAAALgSQAKgTAAgiQAAgOgBgNQgDgMgEgJQgEgJgJgGQgHgFgNAAQgbAAgKATg");
	this.shape_12.setTransform(-66,5.5);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#333333").s().p("AAsBpIgqhSIgGAAIgqBSIg/AAIA+hqIg9hnIBCAAIAnBOIAGAAIAohOIBAAAIg9BmIBABrg");
	this.shape_13.setTransform(-88.2,5.5);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#333333").s().p("AhKBSQgYgcAAg2QAAhtBnAAQAdAAASAIQATAHAKAOQAKAOAEATQAEATAAAWIAAAUIiHAAQAAAWAIANQAMATAgAAQAZAAAPgGIAcgMIALAmQgGAEgKADIgWAIQgMADgNACQgNACgNAAQg4AAgYgcgAgQhCQgJAEgFAJQgEAIgBANIgBAJIBJAAQAAgXgIgMQgHgMgSAAQgMAAgIAEg");
	this.shape_14.setTransform(-119.6,5.5);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#333333").s().p("ABKBpIAAjRIA8AAIAADRgAiFBpIAAjRIA7AAIAABHIAyAAQAPAAAMAFQAOAEAKAIQAKAJAGALQAGANAAARQAAATgGANQgGAOgLAIQgLAJgPAEQgNAEgSAAgAhKBAIAiAAQAeAAAAgeQAAgMgIgHQgHgIgPAAIgiAAg");
	this.shape_15.setTransform(-145.9,5.5);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#333333").s().p("AhdBpIAAjRIBuAAQAgAAASANQASAMAAAcQABARgKALQgKALgQAGQASAGANAKQANAMAAAXQAAAPgFALQgHALgJAIQgKAHgMAEQgMAEgOAAgAgjBAIArAAQAaAAAAgaQAAgKgHgHQgGgHgNAAIgrAAgAgjgWIAqAAQAMAAAFgGQAFgHAAgJQAAgIgEgFQgGgGgLAAIgrAAg");
	this.shape_16.setTransform(-171.5,5.5);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#333333").s().p("Ag0BmQgUgHgMgPQgMgOgEgVQgFgUAAgZQAAg2AbgcQAbgbA3AAQAeAAATAIQAUAHALAPQAMAOAFAVQAFAVAAAYQAAA3gbAbQgbAbg4AAQgdAAgTgIgAghgyQgLASAAAiQAAAOACANQACAMAEAJQAEAKAIAFQAIAFAMAAQAcAAALgSQAKgTAAgiQAAgOgBgNQgCgMgFgJQgFgJgHgGQgIgFgNAAQgbAAgKATg");
	this.shape_17.setTransform(-194.6,5.5);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#333333").s().p("AA+CYIAAiAIh7AAIAACAIg9AAIAAkvIA9AAIAACAIB7AAIAAiAIA9AAIAAEvg");
	this.shape_18.setTransform(-221.4,0.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-239,-28.7,478.2,57.4);
...
(lib.blackBlk = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("EicOAPnIAA/NME4dAAAIAAfNg");
...
p.nominalBounds = new cjs.Rectangle(-581,-99,702.3,200);
...
p.nominalBounds = new cjs.Rectangle(-543,-249,652,500);
...
(lib.t0 = function(mode,startPosition,loop) {
	...
	this.t2.setTransform(0.1,27.7);

	this.t1 = new lib.Symbol1();
	this.t1.setTransform(0.1,-17);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.t1},{t:this.t2}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-239,-45.7,478.2,91.6);
...
(lib.inv = function(mode,startPosition,loop) {
	...
	this.t3.setTransform(-3.7,84.6);

	this.timeline.addTween(cjs.Tween.get(this.t3).wait(1));

	// Layer 1 copy
	this.t2 = new lib.Symbol7();
	this.t2.setTransform(7.7,18.4);
...
p.nominalBounds = new cjs.Rectangle(-89.4,-41.7,190.2,136.1);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		tl.fromTo(r.blk, 1.0, {alpha:1}, {alpha:0, ease:Power0.easeNone})
		  ...
		  .from(r.hol1, 1.0, {y:"+=250", ease:Expo.easeOut}, 0.5)
		  .from(r.hol1.mc, 4.0, {y:"+=10", ease:Power0.easeNone}, 0.5)
		  .staggerFrom([r.t0.t1, r.t0.t2], 0.9, {y:"+=250", ease:Expo.easeOut}, 0.1, 1.00)
		  
		  
		  //2
		  .from(r.blk_black, 0.6, {alpha:0, ease:Power0.easeNone}, time2)
		  .to(r.logo_lg.gr, 0.6, {alpha:0, ease:Power0.easeNone}, time2)
		  .staggerFrom([r.inv.t1, r.inv.t2, r.inv.t3], 0.9, {y:"+=250", ease:Expo.easeOut}, 0.1, time2+0.5)
		  .from(r.t1.pic, 1.2, {scaleX:2.0, scaleY:2.0, alpha:0, ease:Expo.easeOut}, time2+0.7)
		  .staggerFrom([r.t1.t1, r.t1.t2, r.t1.t3], 0.9, {y:"+=250", ease:Expo.easeOut}, 0.1, time2+0.9)
		  
		  
		  //3
		  .to(r.t1.pic, 0.5, {alpha:0, ease:Power0.easeNone}, time3)
		  .staggerTo([r.t1.t1, r.t1.t2, r.t1.t3], 0.4, {y:"-=250", ease:Expo.easeIn}, 0.05, time3)
		  ...
		  .staggerTo([r.t2.t1, r.t2.t2], 0.4, {y:"-=250", ease:Expo.easeIn}, 0.05, time4)
		  ...
		  .from(r.t100.hol2, 1.0, {y:"+=250", ease:Expo.easeOut}, time5+0.5)
		  .staggerFrom([r.t100.t1, r.t100.t2, r.t100.t3, r.t100.t4, r.t100.t5, r.t100.t6, r.t100.t10, r.t100.bens], 0.9, {y:"+=250", ease:Expo.easeOut}, 0.04, time5+0.6)
		...
		function replay() {
		  if (count == repeat){
		      console.log("count =", count, "; repeat =", repeat);
		      tl.pause();
		  } else {
		  if (count != repeat) {
			  console.log("count =", count, "; repeat =", repeat);
	...
	// Layer 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(0,0,0,0.498)").ss(2,1,1).p("EicPgPnME4fAAAIAAfPMk4fAAAg");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// blk
	this.blk = new lib.blk();
	this.blk.setTransform(0,0,8.333,0.5);

	this.timeline.addTween(cjs.Tween.get(this.blk).wait(1));

	// logo_lg
	this.logo_lg = new lib.sprite36();
	this.logo_lg.setTransform(-430,-55.2,1.5,1.5);

	this.timeline.addTween(cjs.Tween.get(this.logo_lg).wait(1));

	// btn
	this.btn = new lib.Symbol8_1();
	this.btn.setTransform(14.1,65.5,1.1,1.1);

	this.timeline.addTween(cjs.Tween.get(this.btn).wait(1));

	// t100
	this.t100 = new lib.t100();
	this.t100.setTransform(155,-55);
	...
	this.inv.setTransform(-250.9,-0.1);

	this.timeline.addTween(cjs.Tween.get(this.inv).wait(1));

	// t3
	this.t3 = new lib.t3();
	this.t3.setTransform(326,0);

	this.timeline.addTween(cjs.Tween.get(this.t3).wait(1));

	// t2
	this.t2 = new lib.t2();
	this.t2.setTransform(326,0);

	this.timeline.addTween(cjs.Tween.get(this.t2).wait(1));

	// t1
	this.t1 = new lib.t1();
	this.t1.setTransform(326,0);
	...
	// t0
	this.t0 = new lib.t0();
	this.t0.setTransform(-112.8,8);

	this.timeline.addTween(cjs.Tween.get(this.t0).wait(1));

	// hol1
	this.hol1 = new lib.Symbol19();
	this.hol1.setTransform(307,3);

	this.timeline.addTween(cjs.Tween.get(this.hol1).wait(1));

	// bg_pattern
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.rf(["#FFFFFF","#D4D2D2"],[0,1],-232.6,-29.3,0,-232.6,-29.3,763.6).s().p("EicOAPnIAA/NME4dAAAIAAfNg");

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1001,-249,2002,500);


// stage content:
(lib.lg_ref_100pcx200 = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});

	// mask (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("EicOAPoIAA/PME4dAAAIAAfPg");
	mask.setTransform(1000,100);

	// movie
	this.rolik = new lib.content();
	this.rolik.setTransform(1000,100);
